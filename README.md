...
| 0 | 0 | 14 | D? | SMD LEDs | - | [859-LTW-220DS5](https://www.mouser.de/ProductDetail/Lite-On/LTW-220DS5?qs=xb8aMrBSZRKaoLOPaZYE%252BQ%3D%3D) or [XIASONGXIN LIGHT - Side SMD 0805 (choose warm white)](https://de.aliexpress.com/item/32890300371.html) |
...
Tkae care to select the correct Chip in Arduino under `Tools -> Chip -> ATtiny212`, the correct Programmer under `Tools -> Programmer -> SerialUPDI - 230400 baud` (probably, depending on what you have) as well as the correct clock source under `Tools -> Clock -> "5 MHz internal"`
